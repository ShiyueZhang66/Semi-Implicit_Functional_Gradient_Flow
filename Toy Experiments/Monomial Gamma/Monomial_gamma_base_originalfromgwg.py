...
sample = exp.sampler(n_sample=1000).cpu().detach().numpy()
...
# np.savetxt(
#     # f'../monomial_gamma_correct_results_target1000/mono_originalbase_l2gf_{seed}.txt',
#     f'../monomial_gamma_correct_results_target1000/mono_originalbase_adagwg_{seed}.txt',
#     kl_list)
